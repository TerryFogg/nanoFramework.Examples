...
namespace nf_Fonts
{
    internal class FontExample
    {
        public FontExample(Bitmap fullScreenBitmap, Font DisplayFont)
        {
            ...
            fullScreenBitmap.DrawText(strSmallFont, fntSmall, randomColor1, 10, 10);
            fullScreenBitmap.DrawText(strSegoeUIRegular12, fntSegoeUIRegular12, randomColor2, 10, 10 + fntSmall.Height);
            fullScreenBitmap.DrawText(strNinaFont, fntNinaB, randomColor3, 10, 10 + fntSmall.Height + fntSegoeUIRegular12.Height);
            fullScreenBitmap.DrawText(strComicSansMS16, fntComicSansMS16, randomColor4, 10, 10 + fntSmall.Height + fntSegoeUIRegular12.Height+fntNinaB.Height);
