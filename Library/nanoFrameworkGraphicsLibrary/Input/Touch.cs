...
namespace nanoFramework.UI.Input
{
    ...
    public sealed class TouchEvents
    {
        ...
        ///
        /// </summary>
        public static readonly RoutedEvent TouchDownEvent = new RoutedEvent(
            "TouchDownEvent", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
        /// <summary>
        ///
        /// </summary>
        public static readonly RoutedEvent TouchMoveEvent = new RoutedEvent(
            "TouchMoveEvent", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
        /// <summary>
        ///
        /// </summary>
        public static readonly RoutedEvent TouchUpEvent = new RoutedEvent(
            "TouchUpEvent", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
        /// <summary>
        ///
        /// </summary>
        public static readonly RoutedEvent TouchGestureEvent = new RoutedEvent(
            "TouchGestureEvent", RoutingStrategy.Tunnel, typeof(TouchEventArgs));
    }
    ...
    public class TouchEventArgs : InputEventArgs
    {
        ...
        public TouchEventArgs(InputDevice inputDevice, DateTime timestamp,
                              TouchCoordinate touches)
        ...
        ///
        public void GetPosition(UIElement relativeTo, out int x, out int y)
        {
            x = Touches.X;
            y = Touches.Y;
