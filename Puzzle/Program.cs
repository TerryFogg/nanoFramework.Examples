    ...
    public class MyPuzzle : Application
    {
        ...
        protected class Button : UIElement
        {
            ...
            private SolidColorBrush _normalBackgroundBrush =
                new SolidColorBrush(Color.FromArgb(192, 192, 192));
            private SolidColorBrush _pressedBackgroundBrush =
                new SolidColorBrush(Color.FromArgb(128, 128, 128));

            private Pen _borderPen =
                new Pen(Color.FromArgb(128, 128, 128));

            private Pen _pressedBorderPen =
                new Pen(Color.FromArgb(128, 128, 128));

            private Pen _lightShade =
                new Pen(Color.FromArgb(216, 216, 216));
            private Pen _darkShade =
                new Pen(Color.FromArgb(64, 64, 64));
