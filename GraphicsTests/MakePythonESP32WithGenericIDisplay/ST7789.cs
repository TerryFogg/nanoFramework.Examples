                ...
                get
                {
                    if (_driver == null)
                    {
                        _driver = new GraphicDriver()
                        {
                            ...
                            (byte)GraphicDriverCommandType.Command, 2, (byte)ST7789V_CMD.VCOMS_Setting, 0x19,
                            (byte)GraphicDriverCommandType.Command, 2, (byte)ST7789V_CMD.LCM_Control, 0x2C,
                            (byte)GraphicDriverCommandType.Command, 2, (byte)ST7789V_CMD.VDV_VRH_Command_Enable, 0x01, 
                            (byte)GraphicDriverCommandType.Command, 2, (byte)ST7789V_CMD.VRH_Set, 0x12,
                            ...
                            (byte)GraphicDriverCommandType.Command, 15, (byte)ST7789V_CMD.Positive_Voltage_Gamma, 0xD0, 0x04, 0x0D, 0x11, 0x13, 0x2B, 0x3F, 0x54, 0x4C, 0x18, 0x0D, 0x0B, 0x1F, 0x23,
                            (byte)GraphicDriverCommandType.Command, 15, (byte)ST7789V_CMD.Negative_Voltage_Gamma, 0xD0, 0x04, 0x0C, 0x11, 0x13, 0x2C, 0x3F, 0x44, 0x51, 0x2F, 0x1F, 0x1F, 0x20, 0x23,
