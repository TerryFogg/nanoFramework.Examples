...
namespace nf_Threading
{
    ...
    public class Program
    {
        ...
        {
            Debug.WriteLine("Thread join demo");
            ...
            while (!threadJoinMethodThread.Join(100))
            {
                ...
                Debug.WriteLine("   Waiting for thread to exit");
            }
        ...
        private static void TimerDemoMethod(Object o)
        {
            ...
            // call.
            Debug.WriteLine("In TimerDemoMethod: " + DateTime.UtcNow);
        }
        ...
        private static void EventDemo()
        {
            ...
            Debug.WriteLine("Signal received from DoSomething thread");
        }
