...
namespace nf_SimpleNPF
{
    internal class SimpleNF : Application
    {
        ...
        public void Initialize()
        {
            ...
            SimpleNF myApplication = new SimpleNF();
        ...
        public void GoHome()
        {
            Buttons.Focus(SimpleNF.mainWindow);
        }
        ...
        {
            protected SimpleNF _program;

            /// <summary>
            /// Constructs a PresentationWindow for the specified program.
            /// </summary>
            /// <param name="program"></param>
            protected PresentationWindow(SimpleNF program)
            {
                _program = program;
        ...
        internal sealed class MainMenuWindow : PresentationWindow
        {
            ...
            /// </summary>
            /// <param name="program"></param>
            public MainMenuWindow(SimpleNF program)
                : base(program)
            {
        ...
        internal sealed class StackPanelDemo : PresentationWindow
        {
            ...
            /// </param>
            public StackPanelDemo(SimpleNF program, Orientation orientation)
                : base(program)
            {
        ...
        internal sealed class CanvasPanelDemo : PresentationWindow
        {
            ...
            /// </summary>
            /// <param name="program"></param>
            public CanvasPanelDemo(SimpleNF program)
                : base(program)
            {
